		...
		<form method="post" action="<?=site_url('anggaran/tambah');?>">
			<div class="box_laporan"><a type='text' style='font-size: 12px;font-weight: bold;position: relative;top: 2px;left: 15px;'>
				...
				<input name="jumlah" type="number" class="feedback-input" placeholder="Rp" style="color: #3059E8;" min="10000" required/>
				...
				<input name="awal" type="date" class="feedback-input" required/>
				...
				<input name="akhir" type="date" class="feedback-input" min="<?= date('Y-m-d')?>" required/>
